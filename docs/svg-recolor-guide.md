...
Complete tutorial for using the SVG recolor tool with Power BI PBIP projects.
...
```powershell
.\svg-recolor\scripts\detect-colors.ps1 -PbipDir "C:\Projects\SalesReport"
```
...
```powershell
.\svg-recolor\scripts\recolor.ps1 `
...
foreach ($proj in $projects) {
    ...
    .\svg-recolor\scripts\recolor.ps1 -PbipDir $proj -To $newColor
}
```
...
```powershell
# Blue theme
.\svg-recolor\scripts\recolor.ps1 -PbipDir "C:\MyProject" -To "#0078D4"

# Red theme
.\svg-recolor\scripts\recolor.ps1 -PbipDir "C:\MyProject" -To "#E74856"

# Green theme
.\svg-recolor\scripts\recolor.ps1 -PbipDir "C:\MyProject" -To "#107C10"
```
...
# Make changes
.\svg-recolor\scripts\recolor.ps1 -PbipDir "." -To "#FF0000"
...
# Test on copy
.\svg-recolor\scripts\recolor.ps1 -PbipDir "C:\MyProject-Test" -To "#FF0000"
...
```powershell
# ❌ Wrong
.\svg-recolor\scripts\recolor.ps1 -PbipDir "C:\MyProject\MyProject.Report"

# ✅ Correct
.\svg-recolor\scripts\recolor.ps1 -PbipDir "C:\MyProject"
```
...
3. **SVG uses named colors**: The tool only replaces hex colors, not named colors like `red` or `blue`
...
- [Tool-Specific README](../svg-recolor/README.md)
