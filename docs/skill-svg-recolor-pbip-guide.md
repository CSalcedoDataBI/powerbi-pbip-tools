...
```powershell
.\skills\skill-svg-recolor-pbip\scripts\detect-colors.ps1 -PbipDir "C:\Projects\SalesReport"
```
...
foreach ($proj in $projects) {
    ...
    .\skills\skill-svg-recolor-pbip\scripts\recolor.ps1 -PbipDir $proj -To $newColor
}
```
...
```powershell
# Blue theme
.\skills\skill-svg-recolor-pbip\scripts\recolor.ps1 -PbipDir "C:\MyProject" -To "#0078D4"

# Red theme
.\skills\skill-svg-recolor-pbip\scripts\recolor.ps1 -PbipDir "C:\MyProject" -To "#E74856"

# Green theme
.\skills\skill-svg-recolor-pbip\scripts\recolor.ps1 -PbipDir "C:\MyProject" -To "#107C10"
```
...
# Make changes
.\skills\skill-svg-recolor-pbip\scripts\recolor.ps1 -PbipDir "." -To "#FF0000"
...
# Test on copy
.\skills\skill-svg-recolor-pbip\scripts\recolor.ps1 -PbipDir "C:\MyProject-Test" -To "#FF0000"
...
```powershell
# ❌ Wrong
.\skills\skill-svg-recolor-pbip\scripts\recolor.ps1 -PbipDir "C:\MyProject\MyProject.Report"

# ✅ Correct
.\skills\skill-svg-recolor-pbip\scripts\recolor.ps1 -PbipDir "C:\MyProject"
```
...
- [Skill-Specific README](../skills/skill-svg-recolor-pbip/README.md)
