...
> [!WARNING]
> This tool modifies SVG files **in-place**. No automatic backup is created.

> [!TIP]
> Always commit your PBIP project to Git before running the tool, so you can easily revert if needed.
...
- [Full Documentation](../../docs/svg-recolor-guide.md)
